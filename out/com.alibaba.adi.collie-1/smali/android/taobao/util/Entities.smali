.class public Landroid/taobao/util/Entities;
...
.field public static final HTML32:Landroid/taobao/util/Entities; = null

.field public static final HTML40:Landroid/taobao/util/Entities; = null
...
.field public static final XML:Landroid/taobao/util/Entities;
...
.field private entityValueToName:Landroid/taobao/util/IntHashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/taobao/util/Entities;->BASIC_SET:[[Ljava/lang/String;
    ...
    sput-object v0, Landroid/taobao/util/Entities;->APOS_SET:[[Ljava/lang/String;
    ...
    sput-object v0, Landroid/taobao/util/Entities;->ISO_8859_1_SET:[[Ljava/lang/String;
    ...
    sput-object v0, Landroid/taobao/util/Entities;->HTML40_SET:[[Ljava/lang/String;

    .line 312
    new-instance v0, Landroid/taobao/util/Entities;

    invoke-direct {v0}, Landroid/taobao/util/Entities;-><init>()V

    sput-object v0, Landroid/taobao/util/Entities;->XML:Landroid/taobao/util/Entities;

    .line 313
    sget-object v0, Landroid/taobao/util/Entities;->XML:Landroid/taobao/util/Entities;

    sget-object v1, Landroid/taobao/util/Entities;->BASIC_SET:[[Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/taobao/util/Entities;->addEntities([[Ljava/lang/String;)V

    .line 314
    sget-object v0, Landroid/taobao/util/Entities;->XML:Landroid/taobao/util/Entities;

    sget-object v1, Landroid/taobao/util/Entities;->APOS_SET:[[Ljava/lang/String;
    ...
    sput-object v0, Landroid/taobao/util/Entities;->HTML32:Landroid/taobao/util/Entities;

    .line 317
    sget-object v0, Landroid/taobao/util/Entities;->HTML32:Landroid/taobao/util/Entities;
    ...
    sget-object v1, Landroid/taobao/util/Entities;->ISO_8859_1_SET:[[Ljava/lang/String;
    ...
    sput-object v0, Landroid/taobao/util/Entities;->HTML40:Landroid/taobao/util/Entities;

    .line 321
    sget-object v0, Landroid/taobao/util/Entities;->HTML40:Landroid/taobao/util/Entities;
    ...
    sget-object v1, Landroid/taobao/util/Entities;->HTML40_SET:[[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/taobao/util/Entities;->entityNameToValue:Ljava/util/Hashtable;

    .line 333
    new-instance v0, Landroid/taobao/util/IntHashMap;

    invoke-direct {v0}, Landroid/taobao/util/IntHashMap;-><init>()V

    iput-object v0, p0, Landroid/taobao/util/Entities;->entityValueToName:Landroid/taobao/util/IntHashMap;
...
.method public addEntities([[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/taobao/util/Entities;->addEntity(Ljava/lang/String;I)V
...
.method public addEntity(Ljava/lang/String;I)V
    ...
    .prologue
    .line 354
    iget-object v0, p0, Landroid/taobao/util/Entities;->entityNameToValue:Ljava/util/Hashtable;
    ...
    .line 355
    iget-object v0, p0, Landroid/taobao/util/Entities;->entityValueToName:Landroid/taobao/util/IntHashMap;

    invoke-virtual {v0, p2, p1}, Landroid/taobao/util/IntHashMap;->put(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/taobao/util/Entities;->lookupTable:[Ljava/lang/String;
...
.method public getEntityName(I)Ljava/lang/String;
    ...
    .line 373
    iget-object v1, p0, Landroid/taobao/util/Entities;->lookupTable:[Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/taobao/util/Entities;->lookupTable:[Ljava/lang/String;
    ...
    .line 377
    iget-object v2, p0, Landroid/taobao/util/Entities;->lookupTable:[Ljava/lang/String;

    iget-object v1, p0, Landroid/taobao/util/Entities;->entityValueToName:Landroid/taobao/util/IntHashMap;

    invoke-virtual {v1, v0}, Landroid/taobao/util/IntHashMap;->get(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1}, Landroid/taobao/util/IntHashMap;->get(I)Ljava/lang/Object;
...
.method public getEntityValue(Ljava/lang/String;)I
    ...
    .prologue
    .line 395
    iget-object v1, p0, Landroid/taobao/util/Entities;->entityNameToValue:Ljava/util/Hashtable;
