...
.method private getNewestId(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 163
    const-string v1, "ANNOUNCEMENT_NEWEST_STORAGE"
...
.method private synMessage()V
    ...
    const-string v2, "mtop.push.msg.announcement"
    ...
    .line 134
    iget-object v2, p0, Lorg/android/agoo/message/AnnouncementControl;->mContext:Landroid/content/Context;

    invoke-direct {p0, v2}, Lorg/android/agoo/message/AnnouncementControl;->getNewestId(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    .line 135
    .local v0, newestId:Ljava/lang/String;
    ...
    .line 139
    :cond_0
    iget-object v2, p0, Lorg/android/agoo/message/AnnouncementControl;->client:Lorg/android/agoo/net/mtop/IMtopAsynClient;

    iget-object v3, p0, Lorg/android/agoo/message/AnnouncementControl;->context:Landroid/content/Context;

    new-instance v4, Lorg/android/agoo/message/AnnouncementControl$1;

    invoke-direct {v4, p0}, Lorg/android/agoo/message/AnnouncementControl$1;-><init>(Lorg/android/agoo/message/AnnouncementControl;)V

    invoke-interface {v2, v3, v1, v4}, Lorg/android/agoo/net/mtop/IMtopAsynClient;->getV3(Landroid/content/Context;Lorg/android/agoo/net/mtop/MtopRequest;Lorg/android/agoo/net/mtop/MtopResponseHandler;)V
...
.method public declared-synchronized start()V
    ...
    :try_start_0
    iget-object v2, p0, Lorg/android/agoo/message/AnnouncementControl;->isStarted:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v3, "AnnouncementControl [started]"
    ...
    :try_start_1
    invoke-static {v2, v3}, Lorg/android/agoo/message/AnnouncementControl;->getTargetTime(II)J
    ...
    invoke-static {v4, v5, v6}, Lorg/android/agoo/util/MurmurHashUtil;->getRandom(JLjava/lang/String;)I
